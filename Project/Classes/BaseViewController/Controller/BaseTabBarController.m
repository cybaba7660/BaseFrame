...
- (void)viewDidLoad {
    ...
    UIImage *normalImage_2 = [[UIImage imageNamed:@"tabbar_home"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *selImage_2 = [[UIImage imageNamed:@"tabbar_home_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UITabBarItem *tabbarItem_2 = [[UITabBarItem alloc] initWithTitle:@"活动" image:normalImage_2 selectedImage:selImage_2];
    
    UIImage *normalImage_3 = [[UIImage imageNamed:@"tabbar_home"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *selImage_3 = [[UIImage imageNamed:@"tabbar_home_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UITabBarItem *tabbarItem_3 = [[UITabBarItem alloc] initWithTitle:@"发现" image:normalImage_3 selectedImage:selImage_3];
    
    UIImage *normalImage_4 = [[UIImage imageNamed:@"tabbar_home"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *selImage_4 = [[UIImage imageNamed:@"tabbar_home_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
