...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _containerBorderColor = UIColor.lightGrayColor;
        _shadowColor = UIColor.whiteColor;
        _containerBackgroudColor = UIColor.whiteColor;
...
- (instancetype)initWithSize:(CGSize)size titleMenus:(NSArray *)titles style:(CPShowStyle *)style
{
    ...
    if (self) {
        ...
        self.table.frame = CGRectMake(0, 0, size.width, size.height);
...
- (instancetype)initWithSize:(CGSize)size titleInfo:(NSArray <NSDictionary<NSString *,NSString *> *>*)infoes style:(CPShowStyle *)style
{
    self = [super initWithFrame:CGRectMake(0, 0, size.width, size.height)];
    if (self) {
        _style = style;
...
- (void)setContent:(UIView *)content
{
    ...
    content.layer.cornerRadius = self.style.containerCornerRadius;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.textColor = _selectedIndex == indexPath.row ? self.style.textColorSelected ? : self.style.textColor : self.style.textColor;
    cell.textLabel.font = _selectedIndex == indexPath.row ? self.style.fontSelected ? : self.style.font : self.style.font;
    cell.contentView.backgroundColor = _selectedIndex == indexPath.row ? self.style.cellBackgroundColorSelected ? : self.style.cellBackgroundColor : self.style.cellBackgroundColor;
...
- (UITableView *)table
{
    if (nil == _table) {
        ...
        _table.rowHeight = self.style.defaultRowHeight;
