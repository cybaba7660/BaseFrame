...
@property (nonatomic, strong) UIColor *shadowColor; // 阴影颜色 默认 UIColor.whiteColor
@property (nonatomic, strong) UIColor *containerBackgroudColor; // 弹出视图背景色 默认 UIColor.whiteColor
...
@property (nonatomic, strong) UIColor *containerBorderColor; // 边框颜色 默认 UIColor.lightGrayColor;
