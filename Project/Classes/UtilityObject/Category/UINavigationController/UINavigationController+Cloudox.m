...
- (void)setNeedsNavigationBackground:(CGFloat)alpha {
    ...
    //导航栏背景透明度
    UIView * barBackground = self.navigationBar.subviews.firstObject;
...
//    UIImageView *shadowView = barBackgroundView.subviews.firstObject;// UIImageView
//    if (self.navigationBar.isTranslucent) {
//        if (shadowView != nil && shadowView.image != nil) {
